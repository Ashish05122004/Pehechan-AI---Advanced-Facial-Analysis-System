...
def analyze_face_features_advanced(image, selected_features=['age', 'gender', 'emotion', 'race']):
    ...
    try:
            ...
            for i in range(2):
                try:
                    ...
                    variant_result = DeepFace.analyze(
                        ...
                        detector_backend='opencv',  # Faster for variants
                        align=True,
                        silent=True
                    )
        ...
        if 'age' in features_to_analyze:
            ...
            age_value = final_age if final_age is not None else int(convert_to_json_serializable(result['age']))
        ...
        final_result = {
            'success': True,
            'data': convert_to_json_serializable(validated_results),
